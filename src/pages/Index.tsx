          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {painPoints.map((point, i) => {
                ...
                return (
                  <div key={i} className="flex items-start gap-4 p-5 bg-red-50/60 border border-red-100 rounded-xl">
                    <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-red-100 text-red-600 flex items-center justify-center">
                      <Icon className="w-5 h-5" />
                    </div>
                    <span className="text-slate-800 font-medium text-lg leading-snug">{point.text}</span>
                  </div>
                );
              })}
            </div>
