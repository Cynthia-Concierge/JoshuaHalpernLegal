  ...
  const pricingTiers = [
    ...
    },
    {
      ...
      features: [
        ...
        "Same-day response time (often within hours)",
        "Dedicated legal partner for strategic planning",
        "M&A readiness, due diligence, and term sheet review",
        "Full compliance buildout (privacy policies, terms, CCPA/GDPR)",
        "Advanced IP portfolio management and enforcement strategy",
        "Multi-state business registration and licensing support",
        "Weekly standing calls + on-demand video meetings",
      ],
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-slate-300">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">Former BigLaw attorney</span>
              </div>
